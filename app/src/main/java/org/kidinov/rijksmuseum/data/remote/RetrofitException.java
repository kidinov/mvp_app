...
/**
 * Give us opportunity to understand kind of error happened with retorfit2 request, e.g.
 * {@link Kind#NETWORK}, {@link Kind#HTTP}, {@link Kind#UNEXPECTED}
 */
public class RetrofitException extends RuntimeException {
    ...
    public RetrofitException(String message, String url, Response response, Kind kind, Throwable exception, Retrofit
            retrofit) {
